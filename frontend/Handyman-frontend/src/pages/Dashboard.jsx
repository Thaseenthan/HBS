...
//   });
  ...
  //   try {
  //     const response = await axios.put("http://localhost:8080/api/v1/request/" + reqId, {
  //       status: "accepted"
  //     });
  
  //     // Get the accepted request data from the response
  //     const acceptedRequest = response.data; // Assuming the API returns the updated request
